...
/*** $stmt = $conn->prepare("SELECT id, name, age FROM myTable WHERE name = ?");
...
$sentusername = trim(filter_input(INPUT_POST, $_POST['username'], FILTER_SANITIZE_STRING));
...
$stmt = $conn->prepare("INSERT INTO user_tb (user_name, user_pass) VALUES (?, ?)");
$stmt->bind_param("ss", $sentusername, $sentuserpass);
$stmt->execute();
$stmt->close();
        ...
        <form>
          <div class="form-group">
            <div class="form-label-group">
              <input type="text" id="username" class="form-control" placeholder="ENTER USRNAME PLS" name="username" required="required" autofocus="autofocus">
